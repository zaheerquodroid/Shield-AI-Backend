# -----------------------------------------------------------------------------
# ShieldAI — Cloudflare Transform Rules for Security Headers
# Equivalent of the CloudFront security-headers module for Cloudflare CDN
# -----------------------------------------------------------------------------
...
resource "cloudflare_ruleset" "security_headers" {
  ...
  description = "Add security headers to all responses — ${var.header_preset} preset"
  kind        = "zone"
  ...
  rules {
    action      = "rewrite"
    expression  = "true"
    description = "Inject security headers"
    enabled     = true
